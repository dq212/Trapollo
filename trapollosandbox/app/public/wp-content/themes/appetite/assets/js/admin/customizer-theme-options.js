...
wp.customize.AppetiteThemeOptions = (function(api) {
  ...
  var component, featuredPageControls; // IDs of the Featured Page controls.
  ...
  _.each(featuredPageControls, function(featuredPageControl) {
    var getFeaturedPageControls = api.control(
      featuredPageControl.pageControlID,
      featuredPageControl.alignmentControlID,
      featuredPageControl.layoutControlID
    );
    getFeaturedPageControls.done(function(
      pageControl,
      alignmentControl,
      layoutControl
    ) {
      component.toggleFeaturedPageLayoutControl(
        pageControl.container,
        alignmentControl.container,
  ...
  component.toggleFeaturedPageLayoutControl = function(
    selectContainer,
    alignmentContainer,
    layoutContainer
  ) {
