...
function appetite_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'appetite_featured_page_one', array(
		 ...
		 'priority' => 2,
		 'panel' => 'appetite_theme_panel',
		 'description' => esc_html__( 'This section displays a featured page on the Front Page template. To display a grid layout, select a page that has child pages. To disable this section, deselect a page by choosing the first option from the Featured Page list.', 'appetite' ),
		 'active_callback' => 'appetite_is_front_page_template',
	) );
	...
	$wp_customize->add_control( 'appetite_featured_page_one_align', array(
		...
		'choices' => array(
			'left' => esc_html__( 'Left', 'appetite' ),
			'right' => esc_html__( 'Right', 'appetite' ),
			'center' => esc_html__( 'Full width', 'appetite' ),
		),
		'priority' => 2,
		'description' => esc_html__( 'Choose a position for your page content.', 'appetite' ),
	) );
	...
	$wp_customize->add_control( 'appetite_featured_page_one_layout', array(
		...
		'priority' => 3,
		'description' => esc_html__( 'Choose a layout for the grid items.', 'appetite' ),
	) );
...
function appetite_customize_preview_js() {
	wp_enqueue_script( 'appetite_customizer', APPETITE_DIR_URI . '/assets/js/admin/customizer.js', array( 'customize-preview' ), '20171105', true );
}
...
function appetite_enqueue_customizer_scripts() {
	wp_enqueue_script( 'appetite-customizer-options-script', APPETITE_DIR_URI . '/assets/js/admin/customizer-theme-options.js', array( 'jquery', 'customize-controls', 'underscore' ), '1.0', true );
}
