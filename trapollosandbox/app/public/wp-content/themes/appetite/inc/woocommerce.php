...
function appetite_woocommerce_scripts() {
	...
	wp_enqueue_style( 'appetite-woocommerce-style', APPETITE_DIR_URI . "/assets/css/woocommerce{$suffix}.css", array(), '1.0.2' );
	wp_style_add_data( 'appetite-woocommerce-style', 'rtl', 'replace' );
    wp_style_add_data( 'appetite-woocommerce-style', 'suffix', $suffix );
